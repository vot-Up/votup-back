...
AUTH_SCHEMAS = {
    "login": extend_schema(
        ...
        examples=[OpenApiExample("Login Example", value={"email": "admin@gmail.com", "password": "TwIu7an43@v1"})],
        responses={
            200: {
...
VOTER_SCHEMAS = {
    ...
    "can_vote": extend_schema(
        ...
        parameters=[OpenApiParameter("cellphone", OpenApiTypes.STR, description="Número do celular", required=True)],
        responses={
            200: {
...
VOTING_SCHEMAS = {
    "voting": extend_schema(
        ...
        request={
            "application/json": {
                "type": "object",
                "properties": {"cellphone": {"type": "string"}},
                "required": ["cellphone"],
            }
        },
        responses={
    ...
    "active_vote": extend_schema(
        ...
        responses={200: {"description": "Votação ativada com sucesso"}, 400: {"description": "Erro ao ativar votação"}},
    ),
    "close_vote": extend_schema(
        ...
        responses={200: {"description": "Votação fechada com sucesso"}, 400: {"description": "Erro ao fechar votação"}},
    ),
}
